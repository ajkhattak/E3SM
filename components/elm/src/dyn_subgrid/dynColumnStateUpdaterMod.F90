...
contains
  ...
  subroutine update_column_state_no_special_handling(this, bounds, clump_index, &
    ...
    !! a note here (fmyuan - 2019/01/08): as below the pointer type is much faster than
    !! the explicit array (which involves a lot of malloc operation).
